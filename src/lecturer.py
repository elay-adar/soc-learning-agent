...
- Every sentence in a documented or secondary block must be supported by the entries the Pack records under that URL. Do not add an explanation, consequence or comparison of your own: put it in its own block tagged inference. A sentence that only points back to an earlier stage ("as explained in stage 2") also goes in an inference block.
